"""
Django settings for ugosuu project.
...
# SECRET_KEY = 'django-insecure-&0&0&wv2m^%$2s#jiwpo=#-hs#&7qfbj#4v_k^e=uphs9wq@oy'
...
ALLOWED_HOSTS = ['ugosuu.up.railway.app', '127.0.0.1',"localhost"]

# During development, you can instead set just the base URL
# (you might decide to change the site a few times).
# ALLOWED_HOSTS = ['.railway.com','127.0.0.1']

## For example, for a site URL is at 'web-production-c5bb.up.railway.app'
## (replace the string below with your own site URL):
CSRF_TRUSTED_ORIGINS = ['https://ugosuu.up.railway.app']
...
WSGI_APPLICATION = 'ugosuu.wsgi.application'
